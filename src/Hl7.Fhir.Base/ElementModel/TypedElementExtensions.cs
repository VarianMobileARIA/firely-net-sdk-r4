...
namespace Hl7.Fhir.ElementModel
{
    public static class TypedElementExtensions
    {
        ...
        public static bool IsExactlyEqualTo(this IBaseElementNavigator left, IBaseElementNavigator right, bool ignoreOrder = false)
        {
        ...
        public static bool Matches(this IBaseElementNavigator value, IBaseElementNavigator pattern)
        {
